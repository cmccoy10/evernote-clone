...
def seed_note_tags():
    ...
    consectetur ante.""", user_id=4, notebook_id=2,  created_on=datetime.datetime.now(), updated_on=datetime.datetime.now())
    ...
    tincidunt, a malesuada nibh faucibus. Nunc a tortor ac ligula porttitor 
    laoreet ac tempor leo. Maecenas eget nulla facilisis, varius libero in, 
    consectetur ante.""", user_id=1, notebook_id=3,  created_on=datetime.datetime.now(), updated_on=datetime.datetime.now())
