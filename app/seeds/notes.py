...
def seed_notes():
    ...
    eget nulla facilisis, varius libero in, consectetur ante.""", user_id=3,
                 notebook_id=4,  created_on=datetime.datetime.now(),
    ...
    egestas.""", user_id=4, notebook_id=2,  created_on=datetime.datetime.now(),
                 updated_on=datetime.datetime.now())
    ...
    Quisque gravida ligula a purus ullamcorper ornare.""", user_id=1, notebook_id=3, created_on=datetime.datetime.now(),
                 updated_on=datetime.datetime.now())
    ...
    Quisque ut neque ac mauris tincidunt maximus eu sed lorem. """, user_id=2,
                 notebook_id=1,  created_on=datetime.datetime.now(),
                 updated_on=datetime.datetime.now())
